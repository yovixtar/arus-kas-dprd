...
<!--     <div class="page-loader-wrapper">
    ...
    <section class="content">
        ...
        switch ($sw) {
            case 'tambahpenerimaanaksi':
                include 'tambah_penerimaan_aksi.php';
                break;
            case 'tambahpengeluaranaksi':
                include 'tambah_pengeluaran_aksi.php';
                break;  
    ...
    <script type="text/javascript">
            ...
            .then((willDelete) => {
              if (willDelete) {
                var xhttp;    
                  ...
                  xhttp.open("GET", "hapus_penerimaan.php?ket_penerimaan="+name, true);
                  xhttp.send();
                swal("Katerangan terhapus !", {
        ...
        function hapusPengeluaran(name) {
            swal({
              title: "Hapus Keterangan",
              text: "Apakah anda yakin akan menghapusnya ?",
              icon: "warning",
            ...
            .then((willDelete) => {
              if (willDelete) {
                var xhttp;    
                  xhttp = new XMLHttpRequest();
                  xhttp.open("GET", "hapus_pengeluaran.php?ket_pengeluaran="+name, true);
                  xhttp.send();
                swal("Katerangan terhapus !", {
                  icon: "success", button:false, timer: 1100,})
                .then((value) => {
